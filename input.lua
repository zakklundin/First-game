...
love.mousepressed = function (mouseX, mouseY, mouseButton)
    ...
    if mouseButton == 1 and state.main_menu then --Mousebutton 1 is the left mouse button
        ...
        if mouseX > 300 and mouseX < (300 + 200) and mouseY > 185 and mouseY < (185 + 100) then
            ...
            --All buttons in settings menu:
            table.insert(buttons, button(300, 100, "Show speed"))
            table.insert(buttons, button(75, 100, "Mute sound"))
            table.insert(buttons, button(525, 100, "Show FPS"))
    ...
    if mouseButton == 1 and state.options then
        ...
        if mouseX > 525 and mouseX < (525 + 200) and mouseY > 100 and mouseY < (100 + 100) then
            showFPS = not showFPS
        end
